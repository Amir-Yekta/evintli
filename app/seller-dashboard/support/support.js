...
import { FiExternalLink } from 'react-icons/fi'; // Using react-icons for the external link icon
    ...
    return(
        <div className="p-6 md:p-8 bg-gray-100 min-h-screen font-sans">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md md:col-span-2 lg:col-span-2"> {/* Spans 2 columns on md and lg */}
                ...
                {/* Feedback Card */}
                <div className="bg-white p-6 rounded-lg shadow-md lg:col-start-3"> {/* Starts in 3rd column on lg to align under Technical Issues */}
